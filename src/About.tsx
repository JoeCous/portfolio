const para1 =
  "I've always had a passion for technology and the decision to make a career change in my late twenties was one of the best I've ever made";
const para2 =
  "As a full stack developer I've had the privilege of working for one of the UK's largest electrical retailers. Building backend services, APIs and user interfaces";
const para3 =
  "Outside of software development I enjoy running, cycling, reading or listening to a podcast (The Rest Is Politics)";
